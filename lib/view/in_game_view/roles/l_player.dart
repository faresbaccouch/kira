...
class Lplayer extends StatelessWidget {
  const Lplayer({Key? key}) : super(key: key);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text("Choose a player to see his role",
                                                            ...
                                                            child: Container(
                                                              decoration:
                                                                ...
                                                                image: DecorationImage(
                                                                    fit: BoxFit
                                                                        .cover,
                                                                    image: AssetImage((data.LColorsController.isNotEmpty &&
                                                                            data.LColorsController.first ==
                                                                                peopleIKill[index].name)
                                                      ...
                                                      Text(
                                                          ...
                                                          style: TextStyle(
                                                              ...
                                                              fontWeight:
                                                                  FontWeight
                                                                      .w500,
                                                              color: data.LColorsController.contains(
                                                                      peopleIKill[
                                                                              index]
                                                                          .name)
                                                                  ? Colors.red
                            ...
                            builder: (ctx, btnData, child) => SizedBox(
                              ...
                              child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                    primary: btnData.LColorsController.isEmpty
                                        ? Colors.grey
                                        : Colors.red),
                                onPressed: () {
